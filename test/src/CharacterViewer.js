      ...
      <div className="input-container">
        ...
        <div className="input-box">
          <InputForm
            ...
            guesses={guesses} // Pass the guesses state to the InputForm
            ...
            >
              {truncateText(currentCharacter.abstract, 499)
                ...
                .map((word, index) => {
                  ...
                  const isWordGuessed = newGuesses.includes(word.toLowerCase());
                      ...
                      {isTitleWord ? (
                        <div
                          ...
                          style={{
                            ...
                            borderColor: isWordGuessed ? "transparent" : "#000",
                          }}
                        >
                          {isWordGuessed ? (
